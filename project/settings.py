...
# メールサーバーへの接続設定
DEFAULT_FROM_EMAIL = 'sakaken2022@gmail.com'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp.gmail.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'sakaken2022@gmail.com'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = 'jaffdaajxqrlyomb' # Gmailのアプリ用パスワードを入力
